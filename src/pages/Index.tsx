...
import { Scissors, Zap, Shield, Brain, Sparkles, Github, Linkedin, Mail } from 'lucide-react';
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-muted-foreground font-medium">by Shivansh Bansal</p>
              </div>
            </div>
            <ThemeToggle />
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="relative group">
              ...
              <div className="relative w-16 h-16 rounded-full overflow-hidden ring-4 ring-primary/20 group-hover:ring-primary/40 transition-all duration-300">
                ...
                />
                <div className="hidden w-full h-full bg-gradient-to-br from-primary via-accent to-primary flex items-center justify-center">
            ...
            <div className="flex gap-4">
              ...
              <a 
                href="https://www.linkedin.com/in/whyshivanshbansal/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-full bg-card/50 backdrop-blur-sm border border-primary/20 flex items-center justify-center hover:bg-primary hover:scale-110 hover:shadow-glow transition-all duration-300 group"
              ...
              <a 
                href="mailto:dreamydase@gmail.com" 
                className="w-11 h-11 rounded-full bg-card/50 backdrop-blur-sm border border-primary/20 flex items-center justify-center hover:bg-primary hover:scale-110 hover:shadow-glow transition-all duration-300 group"
